...
--
-- Hôte : 127.0.0.1
-- Généré le :  lun. 15 avr. 2019 à 04:53
...
(13, 20, 1, 1, '2019-04-13'),
(16, 9, 1, 1, '2019-04-14'),
(17, 10, 1, 1, '2019-04-14');
...
CREATE TABLE `membre` (
  ...
  `panier` varchar(500) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
ALTER TABLE `location`
  MODIFY `idLocation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
