...
<div class="container">
    ...
    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#form_enreg">Ajouter</button>
    
    <!-- The Modal -->
      <div class="modal fade" id="form_enreg">
        <div class="modal-dialog">
            <form id="enregForm" enctype="multipart/form-data" action="enregistrer.php" method="POST" onSubmit="return valider();">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="text" class="form-control" id="titre" name="titre" placeholder="titre du film"><br>
                            <input type="text" class="form-control" id="res" name="res" placeholder="nom du realisateur"><br>                        
                            ...
                            <input type="number" class="form-control" id="duree" name="duree" placeholder="durée du film (min)" min="0"><br>
                            <input type="number" class="form-control" id="prix" name="prix" placeholder="prix de la location" min="0"><br>
